                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                    ...
                    <div className="col-span-2 lg:col-span-2">
                        <Link href="/" className="inline-block mb-4">
                            <img src="/logo.png" alt="Quantum Bull" className="h-12 w-auto" />
                        </Link>
                        <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-sm">
                            Empowering traders with expert education, real-time analysis, and a
                        ...
                        <div className="flex items-center gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    key={social.name}
                                    href={social.href}
                                    className="w-9 h-9 rounded-lg bg-gray-100 hover:bg-[#2EBD59] flex items-center justify-center text-gray-500 hover:text-white transition-all"
